...
namespace practicalWork3.UsersClasses
{
    internal class InfoEmailSending
    {
        ...
        string body)
        {
            ...
            EmailPassword = String.IsNullOrWhiteSpace(emailPassword) ? throw new Exception("Нельзя вставлять пробелы или пустое значение!") : emailPassword;
